 ...
 */
package pws_c.connectionDB_PABD;
...
import pws_c.connectionDB_PABD.exceptions.IllegalOrphanException;
import pws_c.connectionDB_PABD.exceptions.NonexistentEntityException;
import pws_c.connectionDB_PABD.exceptions.PreexistingEntityException;
...
public class TokoJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("pws_c_connectionDB_PABD_jar_0.0.1-SNAPSHOTPU");
